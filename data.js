...
const PRODUCTS = [
  {
    id: "custom",
    name: "Custom Order — Your Design",
    category: "Custom",
    icon: "✨",
    basePrice: 600,
    custom: true,
    desc: "Have your own idea or a 3D file? Describe what you want or share a link to your model. Custom prints start at HK$600 (final price HK$600–1200, confirmed before we print).",
    materials: ["pla", "petg"],
    popular: true,
  },
  {
  ...
  },
  {
    ...
    icon: "🔋",
    basePrice: 330,
    desc: "Desk dock that holds your phone upright while it charges.",
    materials: ["pla", "petg"],
  },
  {
    id: "jewelry-dish",
    name: "Ring & Jewelry Dish",
    category: "Home",
    icon: "💍",
    basePrice: 280,
    desc: "Little trinket dish for rings, earrings and small bits.",
    materials: ["pla", "petg"],
  },
  {
    id: "tealight",
    ...
    icon: "🕯️",
    basePrice: 280,
    desc: "Geometric holder for LED tealight candles.",
    materials: ["pla", "petg"],
  },
  {
    id: "brush-holder",
    ...
    icon: "💄",
    basePrice: 330,
    desc: "Sectioned holder to keep makeup brushes upright and tidy.",
    materials: ["pla", "petg"],
  },
  {
    id: "wall-hooks",
    name: "Wall Hooks (set of 3)",
    category: "Home",
    icon: "🪝",
    basePrice: 290,
    desc: "Adhesive-mount hooks for keys, towels and bags.",
    materials: ["pla", "petg"],
  },
  {
    id: "egg-cup",
    name: "Egg Cups (set of 2)",
    category: "Kitchen",
    icon: "🥚",
    basePrice: 270,
    desc: "Pair of egg cups for your soft-boiled breakfast.",
    materials: ["petg", "pla"],
  },
  {
    id: "spinning-top",
    ...
    icon: "🌪️",
    basePrice: 250,
    desc: "Long-spinning desk top. Printed in one piece.",
    materials: ["pla", "petg"],
  },
  {
    id: "pet-tag",
    ...
    icon: "🐾",
    basePrice: 250,
    desc: "Custom pet tag — tell us the name and phone number to add.",
    materials: ["pla", "petg"],
  },
  {
    id: "bookmark",
    ...
    icon: "🔖",
    basePrice: 250,
    desc: "Slim decorative bookmark with a clip corner.",
    materials: ["pla", "petg"],
  },
  {
    id: "incense-holder",
    ...
    icon: "🪔",
    basePrice: 270,
    desc: "Stick incense holder with an ash-catch tray.",
    materials: ["petg", "pla"],
  },
];
